...
function ver_errores(e) {
  ...
  if (e.status == 403) {
    ...
    sw_error(`Upss!! Estimado <br> ${e.user}!`, `${e.message} <br> <small>─ o contacte al <a href="https://wa.link/1dpx0i" target="_blank" class="cursor-pointer text-primary" >Ing. de Sistemas</a> ─</small>`,  15000);
