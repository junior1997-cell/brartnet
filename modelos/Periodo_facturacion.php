<?php
  ...
  class Periodo_facturacion
  {
    ...
    Public function mini_reporte($periodo,  $cliente, $comprobante){

      $filtro_periodo = ""; $filtro_cliente = ""; $filtro_comprobante = "";
      ...
      WHERE v.sunat_estado = 'ACEPTADA' AND v.estado = '1' AND v.estado_delete = '1' $filtro_periodo $filtro_cliente $filtro_comprobante
      ...
      INNER JOIN periodo_contable as pco ON v.idperiodo_contable = pco.idperiodo_contable
      INNER JOIN persona_cliente as pc ON pc.idpersona_cliente = v.idpersona_cliente 
      WHERE v.sunat_estado = 'ACEPTADA' AND v.tipo_comprobante = '01' AND v.estado = '1' AND v.estado_delete = '1' $filtro_periodo $filtro_cliente $filtro_comprobante;";
      ...
      INNER JOIN periodo_contable as pco ON v.idperiodo_contable = pco.idperiodo_contable
      INNER JOIN persona_cliente as pc ON pc.idpersona_cliente = v.idpersona_cliente 
      WHERE v.sunat_estado = 'ACEPTADA' AND v.tipo_comprobante = '03' AND v.estado = '1' AND v.estado_delete = '1' $filtro_periodo $filtro_cliente $filtro_comprobante;";
      ...
      INNER JOIN periodo_contable as pco ON v.idperiodo_contable = pco.idperiodo_contable
      INNER JOIN persona_cliente as pc ON pc.idpersona_cliente = v.idpersona_cliente 
      WHERE v.sunat_estado = 'ACEPTADA' AND v.tipo_comprobante = '12' AND v.estado = '1' AND v.estado_delete = '1' $filtro_periodo $filtro_cliente $filtro_comprobante;";
