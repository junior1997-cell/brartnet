                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                                  <div class="form-group">
                                    <label for="idproveedor" class="form-label">
                                      <span class="badge bg-info m-r-4px" data-bs-toggle="modal" onclick="limpiar_proveedor();" data-bs-target="#Modal-agregar-proveedor" title="Agredar"><i class="las la-plus"></i></span>
                      ...
                      <div class="col-lg-12 col-xl-6- col-xxl-6">
                        ...
                        <div class="card-body" style="border-radius: 5px; box-shadow: 0 0 2px rgb(0 0 0), 0 1px 5px 4px rgb(255 255 255 / 60%);">
                          <div class="row">
                            ...
                            <!-- Tipo documento -->
                            <div class="mb-1 col-md-3 col-lg-3 col-xl-3 col-xxl-4 mt-3 ">
                              <div class="form-group">
                            ...
                            <!--  Numero Documento -->
                            <div class="mb-1 col-md-3 col-lg-3 col-xl-3 col-xxl-5 mt-3">
                              <div class="form-group">
