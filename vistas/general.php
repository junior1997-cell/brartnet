...
?>
  ...
  <body id="body-usuario">
    ...
    <script src="scripts/plan.js?version_jdl=1.48"></script>
    <script src="scripts/zona.js?version_jdl=1.48"></script>
    <script src="scripts/centro_poblado.js?version_jdl=1.48"></script>
    <script src="scripts/bancos.js?version_jdl=1.48"></script>
    <script src="scripts/cargo_trabajador.js?version_jdl=1.48"></script>
    <script src="scripts/categoria_incidencia.js?version_jdl=1.48"></script>
    <script src="scripts/categoria_otros_gastos.js?version_jdl=1.48"></script>
