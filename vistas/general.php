...
?>
  ...
  <body id="body-usuario">
    ...
    <script src="scripts/plan.js?version_jdl=1.33"></script>
    <script src="scripts/zona.js?version_jdl=1.33"></script>
    <script src="scripts/centro_poblado.js?version_jdl=1.33"></script>
