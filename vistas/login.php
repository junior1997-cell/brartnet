...
<body>
  ...
  <script src="../assets/js/funcion_general.js?version_jdl=1.9"></script>
  <script src="../assets/js/funcion_crud.js?version_jdl=1.9"></script>  

  <script src="scripts/login.js?version_jdl=1.9"></script>  
