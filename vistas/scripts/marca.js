...
function listar_marca(){
  tabla_marca = $('#tabla-marca').dataTable({
    ...
    buttons: [
      ...
      { extend: 'excel', exportOptions: { columns: [0,2,3,4], }, title: 'Lista de Categorías', text: `<i class="far fa-file-excel fa-lg" ></i>`, className: "btn btn-outline-success btn-wave ", footer: true,  }, 
      { extend: 'pdf', exportOptions: { columns: [0,2,3,4], }, title: 'Lista de Categorías', text: `<i class="far fa-file-pdf fa-lg"></i>`, className: "btn btn-outline-danger btn-wave ", footer: false, orientation: 'landscape', pageSize: 'LEGAL',  },
