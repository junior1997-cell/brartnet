...
<body class="landing-body">
  ...
  <script src="assets/js/funcion_crud.js?version_jdl=1.26"></script>

  <script src="vistas/scripts/home.js?version_jdl=1.26"></script>
  <script src="vistas/scripts/login_cliente.js?version_jdl=1.26"></script>
