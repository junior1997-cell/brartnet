...
<body class="landing-body">
  ...
  <script src="assets/js/funcion_crud.js?version_jdl=1.42"></script>

  <script src="vistas/scripts/home.js?version_jdl=1.42"></script>
  <script src="scripts_client/login_cliente.js?version_jdl=1.42"></script>
